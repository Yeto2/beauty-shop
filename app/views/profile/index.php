<html lang="en">
   <head>
      ...
      <!-- responsive css -->
      <link rel="stylesheet" href="<?=ASSETS?>profile/css/responsive.css" />
      <!-- color css -->
      <link rel="stylesheet" href="<?=ASSETS?>profile/css/colors.css" />
      <!-- select bootstrap -->
      <link rel="stylesheet" href="<?=ASSETS?>profile/css/bootstrap-select.css" />
      <!-- scrollbar css -->
      <link rel="stylesheet" href="<?=ASSETS?>profile/css/perfect-scrollbar.css" />
      <!-- custom css -->
      <link rel="stylesheet" href="<?=ASSETS?>profile/css/custom.css" />
   </head>
   <body class="dashboard dashboard_1">
                                          ...
                                          <div id="testimonial_slider" class="carousel slide" data-ride="carousel">
                                             ...
                                             <div class="carousel-inner">
                                                <div class="item carousel-item active">
                                                   <div class="img-box"><img src="<?=ASSETS?>profile/images/layout_img/user_img.jpg" alt=""></div>
                           ...
                           <div class="dash_blog">
                              <div class="dash_blog_inner">
                                 ...
                                 <div class="msg_list_main">
                                    <ul class="msg_list">
                                       <li>
                                          <span><img src="<?=ASSETS?>profile/images/layout_img/msg2.png" class="img-responsive" alt="#" /></span>
                                          <span>
                                       ...
                                       <li>
                                          <span><img src="<?=ASSETS?>profile/images/layout_img/msg3.png" class="img-responsive" alt="#" /></span>
                                          <span>
      ...
      <script src="<?=ASSETS?>profile/js/popper.min.js"></script>
      <script src="<?=ASSETS?>profile/js/bootstrap.min.js"></script>
      <!-- wow animation -->
      <script src="<?=ASSETS?>profile/js/animate.js"></script>
      <!-- select country -->
      <script src="<?=ASSETS?>profile/js/bootstrap-select.js"></script>
      <!-- owl carousel -->
      <script src="<?=ASSETS?>profile/js/owl.carousel.js"></script> 
      <!-- chart js -->
      <script src="<?=ASSETS?>profile/js/Chart.min.js"></script>
      <script src="<?=ASSETS?>profile/js/Chart.bundle.min.js"></script>
      <script src="<?=ASSETS?>profile/js/utils.js"></script>
      <script src="<?=ASSETS?>profile/js/analyser.js"></script>
      <!-- nice scrollbar -->
      <script src="<?=ASSETS?>profile/js/perfect-scrollbar.min.js"></script>
      <script>
         var ps = new PerfectScrollbar('#sidebar');
      </script>
      <!-- custom js -->
      <script src="<?=ASSETS?>profile/js/custom.js"></script>
      <script src="<?=ASSETS?>profile/js/chart_custom_style1.js"></script>
   </body>
</html>
